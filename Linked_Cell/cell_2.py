...
class Cell_2(Cell):
    ...
    def p2p_self(self):
        ...
        for idx_self in range(len(self.particle_list)):
            ...
            for idx_others in list_index[:idx_self]:
                distance = self.particle_list[idx_self].distance(self.particle_list[idx_others])
                self.particle_list[idx_self].phi += utils.lj_potential(distance)
    ...
    def calculate_potential(self, list_cells):
        ...
        #call functions to calculate potential of particles
        self.p2p_self()
        self.p2p_neighbor_cells(list_cells)
